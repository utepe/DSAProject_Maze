...
public class Maze {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Generating maze took: " + (endTime - startTime) / 1000000 + " ms");
        ...
        while(flag){
                ...
                switch (key) {
                    ...
                    case 2 -> {
                        ...
                        System.out.println("Solving maze using Dijkstra's Algorithm took: " + (endTime - startTime) / 1000000 + " ms");
                    ...
                    case 3 -> {
                        ...
                        endTime = System.nanoTime();
                        System.out.println("Solving maze using a recursive algorithm took: " + (endTime - startTime) / 1000000 + " ms");
                    ...
                    case 4 -> {
                        ...
                        endTime = System.nanoTime();
                        System.out.println("Solving maze using breadth-first search took: " + (endTime - startTime) / 1000000 + " ms");
                        MazePanel.BuildGUI(solver3.maze);

                    }
                    case 5 -> {
                        startTime = System.nanoTime();
                        DFSSolver solver4 = new DFSSolver(generated.maze);
                        endTime = System.nanoTime();
                        System.out.println("Solving maze using depth-first search took: " + (endTime - startTime) / 1000000 + " ms");
